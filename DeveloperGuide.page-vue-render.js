...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given contact name is not in the contact list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. Connectify shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The contact already has an existing category")]),_v(" "),_c('ul',[_c('li',[_v("1b1. Connectify informs the user the category that the contact currently is under and requests for confirmation\nto update the current category to the newly given one.")]),_v(" "),_c('li',[_v("1b2a. User confirms the update.\n"),_c('ul',[_c('li',[_c('p',[_v("1b2a1. Connectify updates the current category of the given contact to the new one.")]),_v(" "),_c('p',[_v("Use Case ends")])])])]),_v(" "),_c('li',[_v("1b2b. User cancels the update.\n"),_c('ul',[_c('li',[_c('p',[_v("1b2b1. Connectify does not update the information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given contact name is not in the contact list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. Connectify shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The contact already has an existing company tag.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. Connectify informs the user the company tag that the contact currently has and requests for confirmation\nto update the current company tag to the newly given one.")]),_v(" "),_c('li',[_v("1b2a. User confirms the update.\n"),_c('ul',[_c('li',[_c('p',[_v("1b2a1. Connectify updates the current company tag of the given contact to the new one.")]),_v(" "),_c('p',[_v("Use Case ends")])])])]),_v(" "),_c('li',[_v("1b2b. User cancels the update.\n"),_c('ul',[_c('li',[_c('p',[_v("1b2b1. Connectify does not update the information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Thu, 28 Mar 2024, 19:21:12 GMT+8]")])])])}
}];
