...
with(this){return _c('p',[_c('strong',[_v("Use case: Assign priorities to contacts")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to assign a specific contact with low/medium/high priority")])]),_v(" "),_c('li',[_c('p',[_v("Connectify adds the given priority to the contact and displays the full updated contact information")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given contact name is not in the contact list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. Connectify shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The contact already has an existing priority label.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. Connectify informs the user the priority label that the contact currently has and requests for confirmation\nto update the current priority level to the newly given one.")]),_v(" "),_c('li',[_v("1b2a. User confirms the update.\n"),_c('ul',[_c('li',[_c('p',[_v("1b2a1. Connectify updates the current priority label of the given contact to the new one.")]),_v(" "),_c('p',[_v("Use Case ends")])])])]),_v(" "),_c('li',[_v("1b2b. User cancels the update.\n"),_c('ul',[_c('li',[_c('p',[_v("1b2b1. Connectify does not update the information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Thu, 28 Mar 2024, 15:07:42 GMT+8]")])])])}
}];
